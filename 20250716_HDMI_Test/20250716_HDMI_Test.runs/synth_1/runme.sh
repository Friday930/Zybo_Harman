...
HD_PWD='C:/Zybo_Harman/20250716_HDMI_Test/20250716_HDMI_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7670_HDMI_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV7670_HDMI_Display.tcl
